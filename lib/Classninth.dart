          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.symmetric(horizontal: 12),child: Text('',style: TextStyle(color:Colors.black,fontSize:20))),
                  ...
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.symmetric(horizontal: 4),child: Text('Wed',style: TextStyle(color:Colors.black,fontSize:20))),
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.symmetric(horizontal: 1),child: Text('Thu',style: TextStyle(color:Colors.black,fontSize:20))),
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.symmetric(horizontal: 1),child: Text('Fri',style: TextStyle(color:Colors.black,fontSize:20))),
                ],
              ),
              GridView(
